...
_C.DATASET = CN()
_C.DATASET.DATAROOT = '/media/hcis-s02/disk2/test'
_C.DATASET.VERSION = 'trainval'
_C.DATASET.NAME = 'carla'
...
_C.IMAGE.ORIGINAL_HEIGHT = 160  # Original input RGB camera height
_C.IMAGE.ORIGINAL_WIDTH = 320  # Original input RGB camera width
_C.IMAGE.NAMES = ['CAM_FRONT_LEFT', 'CAM_FRONT', 'CAM_FRONT_RIGHT',  'CAM_BACK']
...
_C.SEMANTIC_SEG.HEATMAP = CN()
_C.SEMANTIC_SEG.HEATMAP.ENABLED = False
